    ...
    fetch("/api/projects")
      ...
      .then((data) => {
        ...
        if (data.success && Array.isArray(raw)) {
          const formatted = raw.slice(0, 3).map((p: any) => {
            ...
            return {
              ...
              tagline: p.shortDescription || (p.beneficiariesImpactedCount ? `${p.beneficiariesImpactedCount} Beneficiaries Targeted` : "Community Initiative"),
              summary: p.fullDescription || p.shortDescription || "",
              mission: p.fullDescription || "Grassroots community service and healthcare dispatch.",
              objectives: [
