          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex flex-col text-right">
              <span className="text-xs font-bold text-slate-900 leading-tight">
                {currentUser?.name || (role === "ADMIN" ? "Administrator" : "Data Officer")}
              </span>
              <span className="text-[10px] text-slate-500">
                {currentUser?.email || (role === "ADMIN" ? "admin@junglan.org" : "dataentry@junglan.org")}
              </span>
            </div>
            ...
            {/* User Avatar */}
            <div
              className="w-8 h-8 rounded-full bg-slate-800 text-white font-bold text-xs flex items-center justify-center border border-slate-700 shadow-2xs"
            ...
            <button
              ...
              title="Sign Out of Foundation Portal"
              className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold text-rose-600 hover:text-rose-700 hover:bg-rose-50 border border-transparent hover:border-rose-200 transition-colors disabled:opacity-50 cursor-pointer"
            >
      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 gap-6">
        ...
        <aside className="hidden lg:block w-64 shrink-0">
          <div className="sticky top-22 bg-white rounded-2xl border border-slate-200 shadow-2xs p-4 space-y-6">
            ...
            {/* Authenticated User Session Card & Sign Out */}
            <div className="pt-4 border-t border-slate-100 space-y-2.5">
              <div className="flex items-center gap-2.5 px-2 py-1.5 rounded-xl bg-slate-50 border border-slate-200/60">
                <div className="w-7 h-7 rounded-full bg-slate-800 text-white font-bold text-[11px] flex items-center justify-center shrink-0">
                  {initials}
                </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl text-xs font-semibold text-rose-600 hover:text-rose-700 bg-rose-50/70 hover:bg-rose-100/70 border border-rose-200/60 transition-colors disabled:opacity-50 cursor-pointer"
              >
                <LogOut className="w-3.5 h-3.5" />
            ...
            <div className="relative w-72 max-w-[85vw] h-full bg-white shadow-2xl p-6 flex flex-col justify-between overflow-y-auto">
              ...
              <div className="pt-6 border-t border-slate-100 space-y-2.5">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl text-xs font-semibold text-rose-600 bg-rose-50 hover:bg-rose-100 border border-rose-200 transition-colors disabled:opacity-50 cursor-pointer"
                >
                  <LogOut className="w-3.5 h-3.5" />
                  <span>{isLoggingOut ? "Signing Out..." : "Sign Out"}</span>
                </button>
